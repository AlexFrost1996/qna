    ...
    context 'Authenticated user' do
      ...
      context 'without valid attributes' do
        it 'does not save the question' do
          expect { post :create, params: { question: attributes_for(:question, :invalid), user: user }, format: :js
                 }.to_not change(Question, :count)
        end
  
        it 'render templete create' do
          post :create, params: { question: attributes_for(:question, :invalid), user: user }, format: :js
